...
- Replace ISP router with firewall such as OPNSense on a suitable PC and use a WAP if needed... Keep it simple, ... and maintainable! (Protip, use dd within Linux live to write a FreeBSD based image)
